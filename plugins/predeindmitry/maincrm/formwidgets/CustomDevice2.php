 ...
 */
class CustomDevice2 extends FormWidgetBase
{
     ...
     * @inheritDoc
     */
    protected $defaultAlias = 'predeindmitry_maincrm_custom_device';
    ...
    public function render()
    {
        ...
        return $this->makePartial('customdevice');
    }
    ...
    {
        $this->addCss('css/customdevice.css', 'PredeinDmitry.MainCRM');
        $this->addJs('js/customdevice.js', 'PredeinDmitry.MainCRM');
    }
